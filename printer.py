...
def election(names,turn,players):
    ...
    stop=0
    while stop!=1:
        actions=['CLAIM INCOME ★','HIT ANOTHER PLAYER ✖',
        'FOREIGN AID ☻','GENERATE TAX $','START EXTORTION ⍗',
        'ASSASSINATE ⚔','START TRADE CHANGE ⇆']
        ...
        if value == 1:
            if player.coins>=7:
                ...
                print("INSUFFICIENT COINS TO FULFILL THIS " 
                "ACTION, PLEASE CHOOSE ANOTHER ACTION \n\n")
...
def priority_challeng(names,turn): #Ready
    participation=[]
    print("challenge priority is set, who of you dares to "
    "challenge player " + names[turn] +" ?")
